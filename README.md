...
- Slave node auto-discovery : Slave nodes are auto-discovered
- Auto task distribution : The library determines which node to send the task to
- Simple API : Using the library is very simple, and it is very flexible
...
Python 3.5.x must also be installed before attempting to use this library.
